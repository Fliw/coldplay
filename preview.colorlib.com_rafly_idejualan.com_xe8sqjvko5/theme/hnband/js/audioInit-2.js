...
(function ($) {
  var songs = [{
    ...
    mp3: "../../theme/hnband/music-files/1.mp3",
    ...
    artist_name: "Ava Max",
    mp3: "../../theme/hnband/music-files/2.mp3",
    ...
    artist_name: "Avicii",
    mp3: "../../theme/hnband/music-files/3.mp3",
    ...
    mp3: "../../theme/hnband/music-files/4.mp3",
    thumb: "../../theme/hnband/img/track-thumbs/1.jpg",
    length: 3.16,
    platform_url: {
      amazon: "#",
    ...
    mp3: "../../theme/hnband/music-files/5.mp3",
    thumb: "../../theme/hnband/img/track-thumbs/2.jpg",
    length: 3.16,
    platform_url: {
      amazon: "#",
    ...
    mp3: "../../theme/hnband/music-files/6.mp3",
    thumb: "../../theme/hnband/img/track-thumbs/3.jpg",
    length: 3.16,
    platform_url: {
      amazon: "#",
